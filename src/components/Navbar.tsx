...
import { Vote, Share2, Menu, X } from "lucide-react";
...
🚀 Developed by Wanted Soft`;
  ...
  return (
    <>
      <nav className="sticky top-0 z-50 backdrop-blur-xl bg-white/80 border-b border-slate-200 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="relative flex items-center justify-between h-16 sm:h-20">
            ...
            {/* Center Title */}
            <div className="absolute left-1/2 -translate-x-1/2 text-center whitespace-nowrap hidden sm:block">
            ...
            <div className="flex items-center gap-2 sm:gap-4">
              ...
              {/* Live Indicator */}
              <div className="flex items-center gap-3">
                <div className="flex items-center gap-2 px-2 sm:px-4 py-2 rounded-xl bg-gradient-to-r from-red-50 to-pink-50 border border-red-200">
      ...
      <div 
        className={`md:hidden fixed top-16 left-0 right-0 bg-white border-b border-slate-200 shadow-lg transition-all duration-300 ease-in-out z-40 ${
          isMobileMenuOpen 
